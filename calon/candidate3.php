...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <h5>Visi: </h5>
  <ol>
    <a>"Menciptakan kepengurusan OSIS yang aktif, kreatif, bertanggung jawab, dan solid, serta menjadikan OSIS sebagai wadah aspirasi siswa-siswi SMK Laboratorium untuk membentuk generasi yang berakhlak mulia, berintegritas, dan peduli terhadap lingkungan sekitar."</a>
  </ol>
  <h5>Misi: </h5>
  <ul>
